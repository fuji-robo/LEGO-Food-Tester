...
class MainGUI:
    ...
    def repeat_action(self):
        self.do_something()
        root.after(1000, self.repeat_action) 
    ...
    def change_text(self, new_text : str):
        self.result_tex.config(text=new_text) 
        #self.result_tex.config(state = NORMAL)
        #self.result_tex.insert(END, new_text)
        #self.result_tex.config(state = DISABLED)
